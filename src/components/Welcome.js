  ...
  return (
    <div>
      <div className="">
        ...
        <aside
          id="default-sidebar"
          className="fixed  left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 mt-16"
          aria-label="Sidebar"
        >
          <div className="h-full px-3 py-4 overflow-y-auto -mt-14 bg-[#1F4887]">
