...
const SideBar = () => {
  return (
    <div className="h-screen fixed top-16 bg-[#1F4887] w-64">
      <div className="h-full p-4 text-white">
        <ul className="space-y-4 mt-16">
          <li>
            ...
            >
              <svg
                ...
                viewBox="0 0 22 21"
              >
                <path d="M17.975 11H10V4.025a1 1 0 0 0-1.066-.998 8.5 8.5 0 1 0 9.039 9.039.999.999 0 0 0-1-1.066h.002Z" />
          ...
          <li>
            ...
            >
              <svg
                className="flex-shrink-0 w-6 h-6 text-white mr-2"
                fill="currentColor"
                viewBox="0 0 18 18"
              >
