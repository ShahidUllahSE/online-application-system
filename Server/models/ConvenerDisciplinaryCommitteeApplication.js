...
const ConvenerDisciplinaryCommitteeApplicationSchema = new mongoose.Schema({
  ...
  module.exports = mongoose.model('ConvenerDisciplinaryCommitteeApplication', ConvenerDisciplinaryCommitteeApplicationSchema);
